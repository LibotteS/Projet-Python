...
from database_manager import store_passwords, retrieve_app_password, find_password_for_accounts, verify_app_name
...
def fill():
    print('Please enter a nickname by which you will recognise the saved site/app (note: this nickname must be unique) : ')
    app_name = input('\nUser => ')
